      ...
      <div class="px-3 pt-5">
        <div class="row text-dark">
          <div
            ...
            <h2 class="main-heading mb-0 head-upper">Publikasi</h2>
            <p class="pre-heading p-upper font-weight-bolder"
              ...
              Saya sangat tertarik pada Data Science, Telekomunikasi dan Keamanan Siber.
            </p>
          </div>
          ...
          <div class="col-md-6" style="margin-top: 45px;">
            <img class="img-fluid d-block img-fluid d-block animate__animated animate__zoomIn animate__delay-1s" src="
              ./assets/images/research-page/icon.png">
          </div>
        </div>
      </div>
    </section>
  ...
  <div class="researchMainWrapper">
    <div class="container">
      <div class="researchDetails">
        <table id="researchDetailsTable" width="100%">
          <tbody class="main">
