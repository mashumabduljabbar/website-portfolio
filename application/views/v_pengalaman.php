  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/experience.css" />
  <div class="main pt-5">
      ...
      <div class="container-fluid px-3 pt-5">
        <div class="row text-dark">
          <div class="col-md-6"> <img class="img-fluid d-block  animate__animated animate__fadeInUp animate__delay-1s"
              src="./assets/images/experience-page/ofon.png" draggable="true" style="margin-top: 45px;"> </div>
          <div
            ...
            <h2 class="main-heading mb-0">Pengalaman</h2>
    ...
    <h4 class="text-center exp-head heading1">Pengalaman Bekerja</h4>
    ...
    <h4 class="text-center heading1">Pengalaman Organisasi</h4>
    ...
    <h4 class="text-center heading1">Pengalaman Magang</h4>
    ...
    <script src="<?php echo base_url();?>assets/js/experience.js"></script>